...
from scripts.models.units_num_extraction.training_setup import training_setup
...
#parser.add_argument('--valid_file_name', type=str, default=None)
...
#parser.add_argument('--predict_file_name', type=str, default=None)
...
#parser.add_argument('--upload_dir', type=str, default='s3://use-class-classifier-temp/checkpoint/')
...
def main(args):
    ...
    reporter = CLIReporter(
        ...
        metric_columns=['validate_loss_avg', 'precision', 'training_iteration'])
    ...
    analysis = tune.run(train_fn_with_parameters, resources_per_trial=resources_per_trial,
                        ...
                        checkpoint_score_attr = 'precision',
